      ...
      <UIExplorerPage title="<ToolbarAndroid>">
        <UIExplorerBlock title="Toolbar with title/subtitle and actions">
          <ToolbarAndroid
            ...
            navIcon={{uri:'ic_menu_black_24dp'}}
...
var toolbarActions = [
  {title: 'Create', icon: {uri:'ic_create_black_48dp'}, show: 'always'},
  {title: 'Filter'},
  {title: 'Settings', icon: {uri:'ic_settings_black_48dp'}, show: 'always'},
];

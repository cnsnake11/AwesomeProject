...
exports.examples = [
  ...
  },
  {
    ...
    description: 'Static assets should be required by prefixing with `image!`' +
      'and are located in the app bundle.已经不支持了，请使用{uri:imgName}的写法而且不推荐使用',
    render: function() {
      return (
        <View style={styles.horizontal}>
          <Image source={{uri:'uie_thumb_normal'}} style={styles.icon} />
          <Image source={{uri:'uie_thumb_selected'}} style={styles.icon} />
          <Image source={{uri:'uie_comment_normal'}} style={styles.icon} />
          <Image source={{uri:'uie_comment_highlighted'}} style={styles.icon} />
        </View>
      );
    },
  },
